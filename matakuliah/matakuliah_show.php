<div class="card">
    ...
    <div class="card-body">
        ...
        <a href="../matakuliah/mahasiswa_print.php" target="_blank" class="btn btn-success mb-2">Cetak Data</a>
        <div class="table-responsive">
            <table class="table table-sm table-bordered table-hover m-0">
                ...
                $query = mysqli_query($con, "SELECT * FROM matakuliah LIMIT $mulai, $limit") or die(mysqli_error($cone));
                ?>
                <thead>
                    <tr>
                        <th>id</th>
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a class="btn btn-sm btn-danger" href="../matakuliah/mahasiswa_delete.php?id=<?php echo $data['id']; ?>" onclick="return confirm('Anda yakin mau menghapus item ini ?')">Hapus</a>
                            </td>
                        </tr>
                    <?php
                        $no++;
